...
style.innerHTML = '.wrapper{background-color:#181a1b!important},.all_content,.header_content.header_content--classic :not(.header__item--appmenu),.home__snippet__extension,.sidebar__item.sidebar__item--maps,.sidebar__item.sidebar__item--music,.sidebar__item.sidebar__item--shopping,.verticals__container,footer{display:none!important}.header__item--appmenu *{display:block!important}.header__item--appmenu{border-left:none}';
